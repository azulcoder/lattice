...
**Content (45 rich modules + 14 drafts; 59 items total = 19 microstructure + 17 geothermal + 23 trading — all catalog items now have content modules):**
...
- ✅ Stober & Bucher 2021 (geothermal, survey-textbook root) — **FINALIZED** (survey format): the 5 general/literature flags (dry-steam exemplars Larderello/Geysers, non-standardized enthalpy cutoffs, heat-flow physics, ~240 °C canonical reservoir T, survey-not-primary framing) verified against the geothermal literature and cleared. Darajat operational facts (capacity, well count — open AZ5) stay external to this survey. Seed cards optional/deferred.
...
- ✅ Tester / MIT 2006 (geothermal, EGS / frontier — petrothermal) — **FINALIZED** (heat-in-place + recovery factor; EGS as the engineered CONTRAST to Darajat's natural dry-steam, NOT Darajat's category): all flags were general/literature claims, verified and cleared. Seed cards optional/deferred.
...
- ✅ **All 17 geothermal catalog items now have content modules** — Acuña + Stober-Bucher + Tester-MIT finalized + 14 audited DRAFTs (incl. Horne 1995 well-testing/PTA, Axelsson 2010 reinjection/tracer, Sanyal 2005 decline/reserves, Giggenbach 1988 production geochemistry, Finger-Blankenship 2010 drilling & completion, Gallup 2009 scaling/corrosion & production chemistry, and Whiting-Ramey 1969 material-balance/lumped modelling — the first DRAFT with an interactive simulator). **As of 2026-06-09 the general/literature flags across all 15 reviewed drafts were verified against the literature and cleared (~80 flags); the ~195 flags that remain are now ONLY genuinely Darajat site-specific operational facts** (well counts, capacity, field T/P, decline rates, real chemistry/isotope values, on-site practice) awaiting Az's sign-off. Remaining geothermal work is the owner-only validation track below.
