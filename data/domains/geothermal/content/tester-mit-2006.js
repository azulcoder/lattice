...
//   A. FRAMING: EGS is PETROTHERMAL (engineer permeability into hot dry rock),
//      the engineered CONTRAST to Darajat's NATURAL vapour-dominated dry-steam
//      hydrothermal system — NOT Darajat's category. Don't imply Darajat is EGS.
//   B. Headline numbers (report's own published findings): in-place resource
//      base ~13 MILLION EJ (seed's "~13,000 EJ" was REFUTED); recoverable
//      >200,000 EJ (~2,000× US 2005 primary energy ~100 EJ/yr); ~100 GWe US by
//      2050; ~USD 0.8-1 B over 15 yr R&D. Verify exact wording if quoting.
//   C. ISBN/page count unconfirmed; catalog type:'paper' → "report" is more precise.
//   D. Worked-example rock properties (ρ_r, C_r, ΔT) illustrative teaching values.
//   E. Author keyWorks (Heat Mining; Sustainable Energy; Thermodynamics &
//      Applications) from general knowledge — confirm editions/years.
//   F. Induced seismicity: report predates Basel (2006) / Pohang (2017) as the
//      cautionary cases; Az may add them.
//   G. Application claim that EGS stimulation techniques transfer to conventional
//      hydrothermal fields — confirm relevance/scope for Darajat.
...
Headline laporan-nya yang ngasih dia pengaruh besar. Nge-asses AS, panel ngestimasi **panas yang tersimpan in-place** sampai kedalaman ~10 km di orde **13 juta EJ** — angka yang begitu besar sampai hampir gak bermakna sendiri. Poin-nya itu fraksi *recoverable*: bahkan dengan asumsi konservatif, panel naruh recoverable EGS resource di **lebih dari 200,000 EJ**, kira-kira **2,000 kali** total pemakaian primary energy tahunan AS (~100 EJ/thn). Atas dasar itu dia memproyeksikan EGS bisa nyediain orde **100 GWe** kapasitas base-load AS yang kompetitif **pada 2050**, dengan investasi R&D berkelanjutan yang dia ukur kira-kira **USD 0.8-1 miliar selama ~15 tahun** — kecil dibanding hadiahnya. Resource-nya, dengan kata lain, bukan constraint-nya; engineering dan cost yang constraint. **⟦TODO-Az: ini figur publikasi laporan-nya sendiri; in-place ~13 juta EJ ngoreksi slip "~13,000 EJ" sebelumnya. EGS itu KONTRAS engineered ke sistem dry-steam natural Darajat — bukan kategori Darajat. Prep §9-A, §9-B.⟧**`
      }
    },
...
The catch — and the reason the report is about R&D, not just resource — is that creating and sustaining the fracture network is hard, deep drilling is expensive, and high-pressure stimulation can trigger felt earthquakes (*induced seismicity*). **⟦TODO-Az: EGS is petrothermal and engineered — it is NOT Darajat's category. Darajat is a natural vapour-dominated hydrothermal system that already has all three ingredients; here it is the contrast, not an EGS example. Prep §9-A.⟧**`,
...
Catch-nya — dan alasan laporan-nya tentang R&D, bukan cuma resource — itu bikin dan ngejaga fracture network itu susah, deep drilling mahal, dan high-pressure stimulation bisa nge-trigger gempa yang kerasa (*induced seismicity*). **⟦TODO-Az: EGS itu petrothermal dan engineered — dia BUKAN kategori Darajat. Darajat itu sistem hydrothermal vapour-dominated natural yang udah punya ketiga ingredient; di sini dia kontras-nya, bukan contoh EGS. Prep §9-A.⟧**`
      }
    },
...
(Unit: 1 EJ = $10^{18}$ J. Logika volumetrik yang sama mendasari estimasi resource geothermal apapun; yang khas dari EGS itu $V_{active}$-nya *dibikin* lewat stimulation bukan diwarisi dari natural permeability, dan dia menyusut dalam usable temperature seiring waktu pas reservoir ngalamin thermal drawdown.) **⟦TODO-Az: range $R_g$ itu punya laporan/Sanyal-Butler; properti rock worked-example di bawah itu nilai teaching ilustratif. Prep §9-B, §9-D.⟧**`
      }
    },
